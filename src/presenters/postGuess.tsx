...
export const PostGuessPresenter = observer(function postGuessRender(props: {
  model: {
  ...
  return (
    <PostGuessView
      ...
      correctSong={{
        artist: props.model.songs[props.model.currentSong].artist,
        title: props.model.songs[props.model.currentSong].title,
      }}
