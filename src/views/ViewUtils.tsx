...
export function Logo(position: string = "relative") {
  return (
    <div onClick={NavigateToLanding} className={position + " top-0 left-0 cursor-pointer "}>
      <h1 className="p-4 hover:text-stone-700 rounded-lg text-2xl md:ml-5 text-black mainfont text-center md:text-left [text-shadow:_0px_4px_8px_rgb(255_255_255_/_1.00)]">
        LyriClue
      </h1>
    </div >
  )
